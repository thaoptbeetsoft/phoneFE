                ...
                <div className="col-lg-6 col-md-6 col-12">
                  <div className="form-group">
                    ...
                    <select name="country_name" id="country">
                      ...
                      <option value="US" >United Kingdom</option>{/*/selected="selected"*/}
                ...
                <div className="col-lg-6 col-md-6 col-12">
                  <div className="form-group">
                    ...
                    <select name="state-province" id="state-province">
                      <option value="divition" >New Yourk</option>{/*/selected="selected"*/}
                ...
                <div className="col-lg-6 col-md-6 col-12">
                  <div className="form-group">
                    ...
                    <select name="company_name" id="company">
                      <option value="company">Microsoft</option>{/*/selected="selected"*/}
                      <option>Apple</option>
